        ...
        <>
                ...
                <div className="banner-text">
                    ...
                    <Link href="/shop">
                        <button className="btn-red">
                            Shop Now <ArrowRight className="SetaButton" />
                        </button>
                    </Link>
                </div>
            ...
            <section className="container collections">
                <div className="collection-item">
                    <img
                        src="https://cartier.vtexassets.com/assets/vtex.file-manager-graphql/images/54f1579e-2547-46e4-9878-ead90265a6c3___df80da292e00fab30a38764111d10dce.jpg"
                ...
                <div className="collection-item">
                    <img
                        src="https://cartier.vtexassets.com/assets/vtex.file-manager-graphql/images/233f42ff-0737-482c-9ab2-82b17df68a9f___dbd7cd3b538b75953c98b2d155be7a75.jpg"
                ...
                <div className="collection-item">
                    <img
                        src="https://cartier.vtexassets.com/assets/vtex.file-manager-graphql/images/5cb8f7c5-59b9-421c-92b4-581fb4fa87b9___7be823840150a7c8e64fb1f4e89264e8.jpg"
                        alt="New Collection"
                    />
